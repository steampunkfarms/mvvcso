      ...
      <form onSubmit={handleSubmit} className="max-w-2xl space-y-6">
        <div className="bg-white rounded-xl border border-stone-200 p-6 space-y-4">
          ...
          <div>
            ...
            <input id="titleEn" name="titleEn" required className="w-full px-4 py-2.5 rounded-lg border border-stone-200 bg-stone-100 text-sm text-(--text-primary) focus:outline-none focus:border-gold-400" />
          </div>
          <div>
            <label htmlFor="descriptionEn" className="block text-sm font-medium text-(--text-primary) mb-1">Description</label>
            <textarea id="descriptionEn" name="descriptionEn" rows={4} className="w-full px-4 py-2.5 rounded-lg border border-stone-200 bg-stone-100 text-sm text-(--text-primary) focus:outline-none focus:border-gold-400" />
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl border border-stone-200 p-6 space-y-4">
          ...
          <div>
            ...
            <input id="titleEs" name="titleEs" className="w-full px-4 py-2.5 rounded-lg border border-stone-200 bg-stone-100 text-sm text-(--text-primary) focus:outline-none focus:border-gold-400" />
          </div>
          <div>
            <label htmlFor="descriptionEs" className="block text-sm font-medium text-(--text-primary) mb-1">Descripción</label>
            <textarea id="descriptionEs" name="descriptionEs" rows={4} className="w-full px-4 py-2.5 rounded-lg border border-stone-200 bg-stone-100 text-sm text-(--text-primary) focus:outline-none focus:border-gold-400" />
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl border border-stone-200 p-6 space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <input id="date" name="date" type="datetime-local" required className="w-full px-4 py-2.5 rounded-lg border border-stone-200 bg-stone-100 text-sm text-(--text-primary) focus:outline-none focus:border-gold-400" />
            </div>
            <div>
              <label htmlFor="endDate" className="block text-sm font-medium text-(--text-primary) mb-1">End Date/Time</label>
              <input id="endDate" name="endDate" type="datetime-local" className="w-full px-4 py-2.5 rounded-lg border border-stone-200 bg-stone-100 text-sm text-(--text-primary) focus:outline-none focus:border-gold-400" />
            </div>
            <div>
              <label htmlFor="location" className="block text-sm font-medium text-(--text-primary) mb-1">Location</label>
              <input id="location" name="location" defaultValue="MVVCSO Community Center" className="w-full px-4 py-2.5 rounded-lg border border-stone-200 bg-stone-100 text-sm text-(--text-primary) focus:outline-none focus:border-gold-400" />
            </div>
            <div>
              <label htmlFor="maxRsvp" className="block text-sm font-medium text-(--text-primary) mb-1">Max RSVPs</label>
              <input id="maxRsvp" name="maxRsvp" type="number" min="0" className="w-full px-4 py-2.5 rounded-lg border border-stone-200 bg-stone-100 text-sm text-(--text-primary) focus:outline-none focus:border-gold-400" />
            </div>
            <div>
              <label htmlFor="category" className="block text-sm font-medium text-(--text-primary) mb-1">Category</label>
              <select id="category" name="category" className="w-full px-4 py-2.5 rounded-lg border border-stone-200 bg-stone-100 text-sm text-(--text-primary) focus:outline-none focus:border-gold-400">
            ...
            <div>
              ...
              <select id="isPublic" name="isPublic" defaultValue="true" className="w-full px-4 py-2.5 rounded-lg border border-stone-200 bg-stone-100 text-sm text-(--text-primary) focus:outline-none focus:border-gold-400">
