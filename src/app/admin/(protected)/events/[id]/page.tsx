      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="flex items-start justify-between mb-4">
              ...
              <div className="flex gap-2">
                ...
                <span className={`px-2 py-0.5 rounded-full text-xs font-medium ${
                  event.isPublic ? 'bg-green-100 text-green-700' : 'bg-dusty-mauve/10 text-dusty-mauve'
                }`}>
          ...
          <div className="bg-white rounded-xl border border-sandy-gold p-6">
            ...
            {rsvps.length === 0 ? (
              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  {rsvps.map(r => (
                    <tr key={r.id} className="border-b border-sandy-gold/20">
        ...
        <div className="space-y-4">
          <a
            ...
            className="flex items-center justify-center gap-2 w-full px-4 py-2.5 rounded-lg border border-sandy-gold text-sm font-medium text-(--text-secondary) hover:bg-cream-light transition-colors"
          >
