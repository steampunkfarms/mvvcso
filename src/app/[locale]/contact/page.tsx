        ...
        <div className="max-w-(--container-max) mx-auto px-(--container-padding)">
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
            ...
            <div className="lg:col-span-2 space-y-8">
              <div>
                ...
                <div className="space-y-5">
                  <div className="flex items-start gap-4">
                    <div className="w-10 h-10 rounded-lg bg-sunset-peach/15 flex items-center justify-center shrink-0">
                  ...
                  <div className="flex items-start gap-4">
                    <div className="w-10 h-10 rounded-lg bg-sunset-peach/15 flex items-center justify-center shrink-0">
                      <Phone className="w-5 h-5 text-terra-cotta" />
                    </div>
                    <div>
                  ...
                  <div className="flex items-start gap-4">
                    <div className="w-10 h-10 rounded-lg bg-sunset-peach/15 flex items-center justify-center shrink-0">
                      <Mail className="w-5 h-5 text-terra-cotta" />
                    </div>
                    <div>
              ...
              {/* Map embed */}
              <div className="rounded-xl overflow-hidden border border-sandy-gold h-64">
                <iframe
